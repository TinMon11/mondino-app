        ...
        <div className='card w-10/12 m-auto flex flex-row flex-wrap justify-center bg-base-100 shadow-xl'>
            ...
            <div className="text-center w-6/12"> 
                ...
                <div className='flex flex-col'>
                    {sendStatus ? <NavLink to="/cart" className="btn btn-primary bg-primary w-24 mx-auto">Ver Carrito</NavLink> : <div className="card-actions justify-center"><ItemCount stock={8} initial={1} onAdd={(n) => onAddEvent(n)} /></div>}
